                ...
                <tr>
                    ...
                    <td>
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <img alt="Avatar" class="table-avatar" src="/images/avatar2.png">
                            </li>
                            <li class="list-inline-item">
                                <img alt="Avatar" class="table-avatar" src="/images/avatar3.png">
                            </li>
                            <li class="list-inline-item">
                                <img alt="Avatar" class="table-avatar" src="/images/avatar4.png">
                            </li>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <img alt="Avatar" class="table-avatar" src="/images/avatar5.png">
                            </li>
                        </ul>
                    </td>
                    <td class="project_progress">
